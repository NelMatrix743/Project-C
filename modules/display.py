...
def success_msg_display(message: str, newline: int = 1) -> None: 
    success_icon: str = "[bold bright_green]:heavy_check_mark:[/]"
...
def info_msg_display(message: str, newline: int = 1) -> None:
    info_icon: str = "[bold bright_yellow](:information_source:)[/]"
...
def warning_msg_display(message: str, newline: int = 1) -> None:
    warning_icon: str = "[blink]:warning-emoji:[/]"
...
def failure_msg_display(message: str, newline: int = 1) -> None:
    failure_icon: str = "[bold]:cross_mark:[/]" 
